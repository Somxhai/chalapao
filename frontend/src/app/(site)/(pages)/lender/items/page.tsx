	...
	return (
		<>
			<div className="w-full max-w-6xl mx-auto px-6">
				<h1 className="text-2xl text-[#000000] font-bold mb-6">
				...
				<div className="flex justify-center gap-20 mb-5 text-sm font-medium border-b border-gray-200">
					...
					<button className="text-[#949494] hover:text-black">
						Currently Rented
					</button>
					<button className="text-[#949494] hover:text-black">
						Available for Rent
					...
					<button className="bg-[#C0C0C0] text-353535 px-4 py-2 rounded-lg hover:bg-gray-600">
						Add New{" "}
					</button>
				</div>
					...
					{items.map((item) => (
						...
						>
							...
							<div className="flex items-center gap-4">
								...
								/>
								<div>
									<div className="text-base text-[#353535] font-bold mb-1">
										{item.name}
									</div>
									<div className="text-sm text-[#353535] ml-4 mb-1">
										{item.description}
									</div>
									<div className="text-sm text-[#353535] ml-4 ">
										{item.views}
									</div>
								</div>
							</div>
							...
							<div className="text-right">
								...
								<div className="font-bold text-[#2D2D2D] mb-2">
									{item.price} บาท/เดือน
								</div>
								<div className="flex gap-2 justify-end">
									<button className="bg-[#D9D9D9] text-[#353535] px-3 py-1 rounded-lg">
										แก้ไขข้อมูล
									</button>
									<button className="bg-[#D9D9D9] text-[#353535] px-3 py-1 rounded-lg">
										ลบผลิตภัณฑ์
