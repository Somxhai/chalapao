...
export interface Item {
	...
	item_images: ItemImage[]; // รูปภาพสินค้า
	keywords: Keyword[]; // คีย์เวิร์ดสินค้า
	item_reviews: ItemReview[] | null; // รีวิวสินค้า
	item_rating: number; // FLOAT(0-5), คะแนนเฉลี่ยของผู้ใช้
}
